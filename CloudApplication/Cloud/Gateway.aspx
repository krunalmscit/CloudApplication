            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="row col-sm-12" style="padding-top: 10px">
                       ...
                       <asp:RadioButtonList ID="rdEnv" runat="server" CssClass=" form-check form-check-inline" RepeatDirection="Horizontal" CellSpacing="10">
                        ...
                        <div class="co-sm-4">
                            <span class="badge badge-dark">App Version : V1.2</span>
                        </div>
                    </div>
                            ...
                            <div class="row" style="padding-top: 10px;">
                                ...
                                <div class="col-sm-8">
                                    <asp:DropDownList ID="drpMonerisTokenization" runat="server" CssClass="form-control">
                                        <asp:ListItem Value="-1" Text="Regular transaction"></asp:ListItem>
                                        <asp:ListItem Value="0" Text="Use Token instead of card"></asp:ListItem>
                                        <asp:ListItem Value="1" Text="Transaction with - Token Request"></asp:ListItem>
                                    </asp:DropDownList>
                                </div>
                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="input-group mb-3">
                                                ...
                                                <asp:TextBox ID="txtSurchargeFeeOnIntracWithCashback" runat="server" Enabled="false" placeholder="Cashback (0-9999)" CssClass="form-control form-group"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="col-sm-4">
                                            <div class="input-group mb-3">
                                                ...
                                                <asp:TextBox ID="txtSurchargeThreshold" runat="server" Enabled="false" placeholder="Threshold (0-9999)" CssClass="form-control form-group"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <table class="table fixed" style="width: 100%; max-height: 500px;">
                            <thead>
                                <tr>
                                    ...
                                    <td><b>Response</b></td>
                                    <td><b>Receipt</b>
                                        <asp:DropDownList ID="drpRceiptType" runat="server" CssClass="form-control dropdown">
                                            <asp:ListItem Text="Customer" Selected="True" Value="C"></asp:ListItem>
                                            <asp:ListItem Text="Merchant" Value="M"></asp:ListItem>
                                        </asp:DropDownList>
                                        <asp:Button ID="btnGetReceiptFromPOSPAD" runat="server" Text="Receipt" OnClick="btnGetReceiptFromPOSPAD_Click" CssClass="btn btn-light" />
                                    </td>
                                </tr>
                            </thead>
                            <tbody>
               ...
               <%-- <div class="col-sm-2">
                    <div class="row">
                        ...
                        <iframe runat="server" height="1000px" id="myFrame" src="http://ec2-184-73-130-151.compute-1.amazonaws.com/cloud/tid/P1209424/logs"></iframe>
                    </div>
                </div>--%>
            </div>
        </div>
